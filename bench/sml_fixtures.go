// Code ported verbatim from github.com/buger/jsonparser/benchmark
// (benchmark.go, MIT) — the SmallPayload/MediumPayload/LargePayload
// fixtures the jsoniter/goccy benchmark lineage publishes on. Types and
// bytes unchanged so the rows are commensurable with theirs.
